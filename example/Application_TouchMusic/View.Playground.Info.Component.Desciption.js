...
function App() {
  ...
  return <layout cx='50%' w={contextApp.locationLayout.w - contextApp.unitpx * 0.08}  h={`${fontSize_0}px`} item>
      ...
      <ReactCanvas2d.TextCaculateLine text={'PHIGROS'} font={`${fontSize_0}px sans-serif`} lineHeight={1} gap={0} w={Infinity} split=' '>
        {
          (line, location) => {
            return <layout w={location.w} h={location.h} item>
              <text fillText fillStyle='rgb(255, 255, 255)' align='center' font={`${fontSize_0}px sans-serif`} lineHeight={1} gap={0} line={line} />
            </layout>
          }
        }
