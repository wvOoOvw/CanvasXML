...
function App() {
  ...
  return <layout container verticalCenter horizontalAlignCenter globalAlpha={animationCountIntersection * 1}>
    ...
    <ReactCanvas2d.TextCaculateLine text={'LOADING...'} font={`${contextApp.unitpx * 0.04}px courier`} lineHeight={1} gap={0} w={contextApp.locationLayout.w - contextApp.unitpx * 0.08} split=' ' wrap>
      {
        (line, location) => {
          return <layout w={location.w} h={location.h} item>
