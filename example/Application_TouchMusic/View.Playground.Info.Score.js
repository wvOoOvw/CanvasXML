...
function App() {
  ...
  return <layout w={contextApp.locationLayout.w - contextApp.unitpx * 0.50} h={`${fontSize_0 + fontSize_1 + gap_0}px`} item>
    ...
    <layout container horizontalBetween verticalAlignCenter>
      <ReactCanvas2d.TextCaculateLine text={'PHIGROS'} font={`${fontSize_2}px sans-serif`} lineHeight={1} gap={0} w={contextApp.locationLayout.w - contextApp.unitpx * 0.08} split=' ' wrap>
        {
          (line, location) => {
            return <layout w={location.w} h={location.h} item>
              <text fillText fillStyle='rgb(255, 255, 255)' align='center' font={`${fontSize_2}px sans-serif`} lineHeight={1} gap={0} line={line} globalAlpha={0.5} />
            </layout>
          }
        }
      </ReactCanvas2d.TextCaculateLine>

      <ReactCanvas2d.TextCaculateLine text={`IN Lv.15`} font={`${fontSize_2}px sans-serif`} lineHeight={1} gap={0} w={contextApp.locationLayout.w - contextApp.unitpx * 0.08} split=' ' wrap>
        {
          (line, location) => {
            return <layout w={location.w} h={location.h} item>
              <text fillText fillStyle='rgb(255, 255, 255)' align='center' font={`${fontSize_2}px sans-serif`} lineHeight={1} gap={0} line={line} globalAlpha={0.5} />
      ...
      <ReactCanvas2d.TextCaculateLine text={String(animationCountGameScoreSuccess).padStart(7, '0')} font={`${fontSize_2}px sans-serif`} lineHeight={1} gap={0} w={contextApp.locationLayout.w - contextApp.unitpx * 0.08} split=' ' wrap>
        {
          (line, location) => {
            return <layout w={location.w} h={location.h} item>
              <text fillText fillStyle='white' align='center' font={`${fontSize_2}px sans-serif`} lineHeight={1} gap={0} line={line} />
            </layout>
          }
        }
      </ReactCanvas2d.TextCaculateLine>
