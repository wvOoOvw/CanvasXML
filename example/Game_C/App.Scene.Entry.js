...
function Content(props) {
  ...
  const { animationCountProcessed: animationCountAppear } = ReactExtensions.useAnimationCount({ play: true, defaultCount: 0, defaultDestination: 1, rate: 1 / 30, postprocess: n => Number(n.toFixed(4)) })
  const { animationCountProcessed: animationCountDisappear } = ReactExtensions.useAnimationCount({ play: destory === true, defaultCount: 0, defaultDestination: 1, rate: 1 / 30, postprocess: n => Number(n.toFixed(4)) })
  const { animationCountProcessed: animationCountWaveInfinity } = ReactExtensions.useAnimationCount({ play: true, defaultCount: 0, defaultDestination: Infinity, rate: 1 / 120, postprocess: n => Number((Math.abs(0.5 - (n + 0.5) % 1) * 2).toFixed(4)) })
  const { animationCountProcessed: animationCountTextInfinity } = ReactExtensions.useAnimationCount({ play: true, defaultCount: 0, defaultDestination: Infinity, rate: 1 / 60, postprocess: n => Number((Math.abs(0.5 - (n + 0.5) % 1) * 2).toFixed(4)) })
...
function Loading(props) {
  ...
  const { animationCountProcessed: animationCountAppear } = ReactExtensions.useAnimationCount({ play: true, defaultCount: 0, defaultDestination: 1, rate: 1 / 30, postprocess: n => Number(n.toFixed(4)) })
  const { animationCountProcessed: animationCountDisappear } = ReactExtensions.useAnimationCount({ play: destory, defaultCount: 0, defaultDestination: 1, rate: 1 / 30, postprocess: n => Number(n.toFixed(4)) })
  const { animationCountProcessed: animationCountInfinityGlobalAlpha } = ReactExtensions.useAnimationCount({ play: true, defaultCount: 0, defaultDestination: Infinity, rate: 1 / 15, postprocess: n => 0.5 - Math.cos(Number(n.toFixed(4))) / 2 })
  const { animationCountProcessed: animationCountInfinity } = ReactExtensions.useAnimationCount({ play: true, defaultCount: 0, defaultDestination: Infinity, rate: 1 / 30, postprocess: n => 0 - Math.cos(Number(n.toFixed(4))) / 2 })
