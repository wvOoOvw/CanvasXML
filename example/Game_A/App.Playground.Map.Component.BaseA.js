...
function Entry(props) {
  ...
  return <layout cx='50%' cy='50%' w={contextPlayground.unitpx} h={contextPlayground.unitpx} onLocationMounted={dom => option.privateDomCollisions.push({ ...dom, type: 'entry' })}>
    ...
    {/* <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(255, 255, 255)' radius={size / 2 - size / 2 * 0.25 * 1} sAngle={Math.PI * 0 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} eAngle={Math.PI * 0.75 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} lineWidth={contextApp.unitpx * 0.012} />
    <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(255, 255, 255)' radius={size / 2 - size / 2 * 0.25 * 1} sAngle={Math.PI * 1 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} eAngle={Math.PI * 1.75 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} lineWidth={contextApp.unitpx * 0.012} />
    <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(255, 255, 255)' radius={size / 2 - size / 2 * 0.25 * 2} sAngle={Math.PI * 0 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} eAngle={Math.PI * 0.75 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} lineWidth={contextApp.unitpx * 0.012} />
    <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(255, 255, 255)' radius={size / 2 - size / 2 * 0.25 * 2} sAngle={Math.PI * 1 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} eAngle={Math.PI * 1.75 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} lineWidth={contextApp.unitpx * 0.012} /> */}
  </layout>
}
...
function Exit(props) {
  ...
  return <layout cx='50%' cy='50%' w={contextPlayground.unitpx} h={contextPlayground.unitpx} onLocationMounted={dom => option.privateDomCollisions.push({ ...dom, type: 'exit' })}>
    ...
    {/* <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(125, 75, 75)' radius={size / 2 - size / 2 * 0.25 * 1} sAngle={Math.PI * 0 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} eAngle={Math.PI * 0.75 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} lineWidth={contextApp.unitpx * 0.012} />
    <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(125, 75, 75)' radius={size / 2 - size / 2 * 0.25 * 1} sAngle={Math.PI * 1 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} eAngle={Math.PI * 1.75 + Math.PI * 0.25 * 1 + Math.PI * animationCountInfinity * 0.1 * -1} lineWidth={contextApp.unitpx * 0.012} />
    <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(125, 75, 75)' radius={size / 2 - size / 2 * 0.25 * 2} sAngle={Math.PI * 0 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} eAngle={Math.PI * 0.75 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} lineWidth={contextApp.unitpx * 0.012} />
    <arctocenter stroke cx='50%' cy='50%' strokeStyle='rgb(125, 75, 75)' radius={size / 2 - size / 2 * 0.25 * 2} sAngle={Math.PI * 1 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} eAngle={Math.PI * 1.75 + Math.PI * 0.25 * 2 + Math.PI * animationCountInfinity * 0.1} lineWidth={contextApp.unitpx * 0.012} /> */}
  </layout>
}
