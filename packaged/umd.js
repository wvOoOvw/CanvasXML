...
const CanvasXML_ReactCanvas2d_Utils_flatDom_ReactCanvas2dUtils = {
  flatDom,
  getDomById
};
/* harmony default export */ const CanvasXML_ReactCanvas2d_Utils_flatDom = (CanvasXML_ReactCanvas2d_Utils_flatDom_ReactCanvas2dUtils);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Utils.getDomById.js
const CanvasXML_ReactCanvas2d_Utils_getDomById_flatDom = dom => {
  return [dom, ...dom.children.map(i => CanvasXML_ReactCanvas2d_Utils_getDomById_flatDom(i)).flat()];
};
const CanvasXML_ReactCanvas2d_Utils_getDomById_getDomById = (dom, id) => {
  if (dom.props.id === id) return dom;
  if (dom.props.id !== id && dom.children !== undefined) return dom.children.find(i => CanvasXML_ReactCanvas2d_Utils_getDomById_getDomById(i, id));
  if (dom.props.id !== id && dom.children === undefined) return undefined;
};
const CanvasXML_ReactCanvas2d_Utils_getDomById_ReactCanvas2dUtils = {
  flatDom: CanvasXML_ReactCanvas2d_Utils_getDomById_flatDom,
  getDomById: CanvasXML_ReactCanvas2d_Utils_getDomById_getDomById
};
/* harmony default export */ const CanvasXML_ReactCanvas2d_Utils_getDomById = (CanvasXML_ReactCanvas2d_Utils_getDomById_ReactCanvas2dUtils);
...
const CanvasXML_ReactCanvas2d_ReactCanvas2dUtils = {
  flatDom: CanvasXML_ReactCanvas2d_Utils_flatDom,
  getDomById: CanvasXML_ReactCanvas2d_Utils_getDomById
};
Object.assign(ReactCanvas2d, ReactCanvas2dComponent, ReactCanvas2dPlugin, CanvasXML_ReactCanvas2d_ReactCanvas2dUtils);
