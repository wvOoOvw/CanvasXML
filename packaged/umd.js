...
// UNUSED EXPORTS: Canvas2d, Canvas2dExtensions, React, ReactCanvas2d, ReactCanvas2dExtensions, ReactExtensions
...
const Hook_UseAnimationDestination_useAnimationDestination = props => {
...
/* harmony default export */ const Hook_UseAnimationDestination = (Hook_UseAnimationDestination_useAnimationDestination);
...
const useAnimationDestinationRateTime = props => {
  ...
  const animationDestination = useAnimationDestination({
...
/* harmony default export */ const Hook_UseAnimationDestinationRateTime = ((/* unused pure expression or super */ null && (useAnimationDestinationRateTime)));
...
const Component_Text_App = props => {
  ...
  const offscreenCanvas = package_React.useRef();
  const offscreenContext = package_React.useRef();
  package_React.useEffectImmediate(() => {
...
function Component_CanvasContainer_App(props) {
  const canvas = package_React.useRef();
  const context = package_React.useRef();
  const dpr = package_React.useRef();
  const rect = package_React.useRef();
  package_React.useEffectImmediate(() => {
  ...
  return /*#__PURE__*/package_React.createElement("canvas", {
...
/* harmony default export */ const Component_CanvasOffscreen = ((/* unused pure expression or super */ null && (Component_CanvasOffscreen_App)));
...
function Component_EventListenerContainer_App(props) {
  const eventListener = package_React.useRef();
  const offscreenCanvas = package_React.useRef();
  const offscreenContext = package_React.useRef();
  package_React.useEffectImmediate(() => {
  ...
  return /*#__PURE__*/package_React.createElement("eventlistener", Component_EventListenerContainer_extends({
...
function Component_PoweredBy_App(props) {
  ...
  if (animationCountDestory !== 1) {
    ...
    }, loadLayout ? /*#__PURE__*/package_React.createElement(package_React.Fragment, null, /*#__PURE__*/package_React.createElement(Component_Text, {
      text: `CanvasXML`,
...
const useLocationProperty = props => {
  const ref = package_React.useRef();
  const [load, setLoad] = package_React.useState(false);
  const [location, setLocation] = package_React.useState(props.default);
...
const Core_mount = (element, canvas, option) => {
  ...
  var Component = /*#__PURE__*/package_React.createElement(Component_CanvasContainer, {
    canvas: canvas,
    dpr: dpr
  }, /*#__PURE__*/package_React.createElement(Component_EventListenerContainer, null, Boolean(powered) === true ? /*#__PURE__*/package_React.createElement(Component_PoweredBy, null, element) : null, Boolean(powered) !== true ? element : null));
  package_React.mount(Component, renderFrameTimeDiffMax, node => Canvas2d.render(Util_CreateDom(Util_FindDom(node))));
  return {
