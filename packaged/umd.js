...
// UNUSED EXPORTS: Canvas2d, Canvas2dModule, Event, Graph, Location, React, ReactCanvas2d, ReactCanvas2dExtensions, ReactExtensions, Tag
...
// EXTERNAL MODULE: ./package/Canvas2d/Module.Graph.js
var Module_Graph = __webpack_require__(851);
var Module_Graph_default = /*#__PURE__*/__webpack_require__.n(Module_Graph);
...
function Component_PoweredBy_App(props) {
  ...
  if (animationCountDestory !== 1) {
    ...
    }, /*#__PURE__*/package_React.createElement(Component_TextCaculateLine, {
      text: `CanvasXML`,
...
const ReactCanvas2d_Core_mount = (element, canvas, option) => {
  ...
  var Component;
  if (Boolean(powered) === true) Component = /*#__PURE__*/package_React.createElement(Component_PoweredBy, null, element);
  if (Boolean(powered) !== true) Component = element;
  Canvas2d.mount(canvas, dpr);
  package_React.mount(Component, renderFrameTimeDiffMax, node => Canvas2d.render(renderDom(createDom(node))));
  return {
...
function Component_Button_App(props) {
  ...
  return /*#__PURE__*/React.createElement("layout", {
    ...
    horizontalAlignCenter: true,
    verticalAlignCenter: true
  }, /*#__PURE__*/React.createElement(TextCaculateLine, {
    text: text,
    font: font,
...
/* harmony default export */ const Hook_UseAudio = ((/* unused pure expression or super */ null && (useAudio)));
...
/* harmony default export */ const Hook_UseEventDragControl = ((/* unused pure expression or super */ null && (useEventDragControl)));
...
/* harmony default export */ const Hook_UseImage = ((/* unused pure expression or super */ null && (useImage)));
...
/* harmony default export */ const Hook_UseLocationBox = ((/* unused pure expression or super */ null && (useLocationBox)));
...
/* harmony default export */ const Hook_UseResourceReload = ((/* unused pure expression or super */ null && (useResourceReload)));
...
/* harmony default export */ const Hook_UseTextCaculateLine = ((/* unused pure expression or super */ null && (useTextCaculateLine)));
