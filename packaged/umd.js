...
// UNUSED EXPORTS: Canvas2d, React, ReactCanvas2d

;// CONCATENATED MODULE: ./package/CanvasXML.React.Plugin.UseAnimationCount.js
...
/* harmony default export */ const CanvasXML_React_Plugin_UseAnimationCount = (useAnimationCount);
;// CONCATENATED MODULE: ./package/CanvasXML.React.Plugin.UseAnimationDestination.js
...
/* harmony default export */ const CanvasXML_React_Plugin_UseAnimationDestination = (useAnimationDestination);
;// CONCATENATED MODULE: ./package/CanvasXML.React.Plugin.UseEffectUpdate.js
...
/* harmony default export */ const CanvasXML_React_Plugin_UseEffectUpdate = (useEffectUpdate);
...
const React = {
  ...
  useMemo,
  useCallback,
  useEffectUpdate: CanvasXML_React_Plugin_UseEffectUpdate,
  useAnimationCount: CanvasXML_React_Plugin_UseAnimationCount,
  useAnimationDestination: CanvasXML_React_Plugin_UseAnimationDestination
};
  ...
  locationMount: dom => {
    ...
    if (Boolean(dom.props.container) === true && dom.children.length > 0) {
      ...
      layoutItem.forEach(i => {
        CanvasXML_Canvas2d.Tag.locationMount(i);
        i.props = {
          ...i.element.props,
          w: i.props.w,
          h: i.props.h
...
;// CONCATENATED MODULE: ./package/CanvasXML.Canvas2d.Tag.Component.Path.js

const CanvasXML_Canvas2d_Tag_Component_Path_App = {
  locationMount: dom => {
    CanvasXML_Canvas2d.Tag.locationMount(dom);
  },
  locationUnmount: dom => {
...
/* harmony default export */ const CanvasXML_Canvas2d_Tag_Component_Path = (CanvasXML_Canvas2d_Tag_Component_Path_App);
...
const renderMount_0 = dom => {
  if (dom.props.save === undefined || Boolean(dom.props.save) === true) CanvasXML_Canvas2d.context().save();
  if (dom.props.beginPath === undefined || Boolean(dom.props.beginPath) === true) CanvasXML_Canvas2d.context().beginPath();
  ...
  if (dom.props.shadowBlur !== undefined) CanvasXML_Canvas2d.context().shadowBlur = dom.props.shadowBlur;
  if (dom.props.shadowColor !== undefined) CanvasXML_Canvas2d.context().shadowColor = dom.props.shadowColor;
  if (dom.props.shadowOffsetX !== undefined) CanvasXML_Canvas2d.context().shadowOffsetX = dom.props.shadowOffsetX;
  if (dom.props.shadowOffsetY !== undefined) CanvasXML_Canvas2d.context().shadowOffsetY = dom.props.shadowOffsetY;
...
const renderMount_1 = dom => {
  ...
  if (Boolean(dom.props.isolated) === true && (dom.props.save === undefined || Boolean(dom.props.save) === true)) CanvasXML_Canvas2d.context().restore();
};
...
const pick = tag => {
  ...
  if (tag === 'path') return CanvasXML_Canvas2d_Tag_Component_Path;
...
const Canvas2dTag = {
  ...
  Circle: CanvasXML_Canvas2d_Tag_Component_Circle,
  ...
  Line: CanvasXML_Canvas2d_Tag_Component_Line,
  Path: CanvasXML_Canvas2d_Tag_Component_Path,
  Rect: CanvasXML_Canvas2d_Tag_Component_Rect,
  RectRadius: CanvasXML_Canvas2d_Tag_Component_RectRadius,
  Scale: CanvasXML_Canvas2d_Tag_Component_Scale,
  Stroke: CanvasXML_Canvas2d_Tag_Component_Stroke,
  Text: CanvasXML_Canvas2d_Tag_Component_Text,
  Translate: CanvasXML_Canvas2d_Tag_Component_Translate
};
...
function CanvasXML_ReactCanvas2d_Component_Accordion_App(props) {
  ...
  CanvasXML_React.useEffectUpdate(() => {
...
function CanvasXML_ReactCanvas2d_Component_Button_App(props) {
  ...
  const animationCountTextRGBA = textColor.map((i, index) => CanvasXML_React.useAnimationDestination({
    play: true,
    defaultCount: i[0],
  ...
  const animationCountRectRGBA = rectColor.map((i, index) => CanvasXML_React.useAnimationDestination({
    play: true,
    defaultCount: i[0],
    destination: i[hover ? 1 : 0],
    rate: Math.abs(i[1] - i[0]) / 15,
...
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseAudio.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseAudio = (useAudio);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseImage.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseImage = (useImage);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseResourceReload.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseResourceReload = (useResourceReload);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseLocationProperty.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseLocationProperty = (useLocationProperty);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseLocationPropertyRef.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseLocationPropertyRef = (useLocationPropertyRef);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseLocationBox.js
...
const useLocationBox = props => {
  ...
  CanvasXML_React.useEffect(() => {
    if (ref.current) {
      ...
      const box = CanvasXML_Canvas2d.Location.box(ReactCanvas2dUtils.flatDom(ref.current).filter(i => i !== ref.current).map(i => i.props));
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseLocationBox = (useLocationBox);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventDragControl.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventDragControl = (useEventDragControl);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventCompose.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventCompose = (useEventCompose);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventClick.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventClick = (useEventClick);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventPointerDown.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventPointerDown = (useEventPointerDown);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventPointerDownAway.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventPointerDownAway = (useEventPointerDownAway);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventPointerMove.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventPointerMove = (useEventPointerMove);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventPointerMoveAway.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventPointerMoveAway = (useEventPointerMoveAway);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventPointerUp.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventPointerUp = (useEventPointerUp);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Plugin.UseEventPointerUpAway.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Plugin_UseEventPointerUpAway = (useEventPointerUpAway);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Utils.FlatDom.js
const flatDom = dom => {
  return [dom, ...dom.children.map(i => flatDom(i)).flat()];
};
/* harmony default export */ const CanvasXML_ReactCanvas2d_Utils_FlatDom = (flatDom);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Utils.GetDomById.js
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Utils_GetDomById = (getDomById);
...
const CanvasXML_ReactCanvas2d_mount = (element, canvas, option) => {
  ...
  var Component;
  if (Boolean(powered) === true) Component = /*#__PURE__*/CanvasXML_React.createElement(CanvasXML_ReactCanvas2d_Component_PoweredBy, null, element);
  if (Boolean(powered) !== true) Component = element;
  CanvasXML_Canvas2d.mount(canvas, dpr);
  CanvasXML_React.mount(Component, renderFrameTimeDiffMax, node => CanvasXML_Canvas2d.render(renderDom(createDom(node))));
  return {
...
const ReactCanvas2d = {
  ...
  useAudio: CanvasXML_ReactCanvas2d_Plugin_UseAudio,
  useImage: CanvasXML_ReactCanvas2d_Plugin_UseImage,
  useResourceReload: CanvasXML_ReactCanvas2d_Plugin_UseResourceReload,
  useLocationProperty: CanvasXML_ReactCanvas2d_Plugin_UseLocationProperty,
  useLocationPropertyRef: CanvasXML_ReactCanvas2d_Plugin_UseLocationPropertyRef,
  useLocationBox: CanvasXML_ReactCanvas2d_Plugin_UseLocationBox,
  useEventDragControl: CanvasXML_ReactCanvas2d_Plugin_UseEventDragControl,
  useEventCompose: CanvasXML_ReactCanvas2d_Plugin_UseEventCompose,
  useEventClick: CanvasXML_ReactCanvas2d_Plugin_UseEventClick,
  useEventPointerDown: CanvasXML_ReactCanvas2d_Plugin_UseEventPointerDown,
  useEventPointerDownAway: CanvasXML_ReactCanvas2d_Plugin_UseEventPointerDownAway,
  useEventPointerMove: CanvasXML_ReactCanvas2d_Plugin_UseEventPointerMove,
  useEventPointerMoveAway: CanvasXML_ReactCanvas2d_Plugin_UseEventPointerMoveAway,
  useEventPointerUp: CanvasXML_ReactCanvas2d_Plugin_UseEventPointerUp,
  useEventPointerUpAway: CanvasXML_ReactCanvas2d_Plugin_UseEventPointerUpAway,
  flatDom: CanvasXML_ReactCanvas2d_Utils_FlatDom,
  getDomById: CanvasXML_ReactCanvas2d_Utils_GetDomById
};
