...
__webpack_require__.d(ReactCanvas2dExtensions_namespaceObject, {
  ...
  Text: () => (Component_Text),
  flatDom: () => (Util_FlatDom),
  getDomById: () => (Util_GetDomById),
...
;// CONCATENATED MODULE: ./package/Canvas2d/Module.Tag.Component.RectRadiusArc.js
const Module_Tag_Component_RectRadiusArc_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Module_Tag_Component_RectRadiusArc = (Module_Tag_Component_RectRadiusArc_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Module.Tag.Component.RectRadiusRect.js
const Module_Tag_Component_RectRadiusRect_App = {
  onConstructMounted: dom => {
    dom.props.radius = dom.element.props.radius && JSON.parse(JSON.stringify(dom.element.props.radius));
  },
  onRenderMount: dom => {
...
/* harmony default export */ const Module_Tag_Component_RectRadiusRect = (Module_Tag_Component_RectRadiusRect_App);
...
const pick = tag => {
  ...
  if (tag === 'rectradiusarc') return Module_Tag_Component_RectRadiusArc;
  if (tag === 'rectradiusrect') return Module_Tag_Component_RectRadiusRect;
...
;// CONCATENATED MODULE: ./package/ReactCanvas2dExtensions/Util.FlatDom.js
const flatDom = dom => {
  return [dom, ...dom.children.map(i => flatDom(i)).flat()];
};
/* harmony default export */ const Util_FlatDom = (flatDom);
;// CONCATENATED MODULE: ./package/ReactCanvas2dExtensions/Util.GetDomById.js
...
/* harmony default export */ const Util_GetDomById = (getDomById);
...
var __webpack_exports__Canvas2dModule = __webpack_exports__.Bf;
...
export { __webpack_exports__Canvas2d as Canvas2d, __webpack_exports__Canvas2dModule as Canvas2dModule, __webpack_exports__React as React, __webpack_exports__ReactCanvas2d as ReactCanvas2d, __webpack_exports__ReactCanvas2dExtensions as ReactCanvas2dExtensions, __webpack_exports__ReactExtensions as ReactExtensions };
