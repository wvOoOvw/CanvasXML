...
__webpack_require__.d(__webpack_exports__, {
  $W: () => (/* reexport */ Canvas2d),
  jt: () => (/* reexport */ Canvas2dExtensions_namespaceObject),
  q_: () => (/* reexport */ React),
  EA: () => (/* reexport */ ReactCanvas2d),
  Yd: () => (/* reexport */ ReactCanvas2dExtensions_namespaceObject),
  wQ: () => (/* reexport */ ReactExtensions_namespaceObject)
});

// NAMESPACE OBJECT: ./package/Canvas2dExtensions/index.js
var Canvas2dExtensions_namespaceObject = {};
__webpack_require__.r(Canvas2dExtensions_namespaceObject);
__webpack_require__.d(Canvas2dExtensions_namespaceObject, {
  Graph: () => (Module_Graph),
  Location: () => (Module_Location),
  caculateRect: () => (Util_CaculateRect),
  createEventLinstener: () => (Util_CreateEventLinstener),
  createOffscreenCanvas: () => (Util_CreateOffscreenCanvas)
});
...
__webpack_require__.d(ReactCanvas2dExtensions_namespaceObject, {
  ...
  CanvasContainer: () => (Component_CanvasContainer),
  CanvasOffscreen: () => (Component_CanvasOffscreen),
  CoordinateHelper: () => (Component_CoordinateHelper),
  EventListenerContainer: () => (Component_EventListenerContainer),
  PoweredBy: () => (Component_PoweredBy),
  Rotate: () => (Component_Rotate),
  RotateCenter: () => (Component_RotateCenter),
  Text: () => (Component_Text),
  useEventClick: () => (Hook_UseEventClick),
  useEventDrag: () => (Hook_useEventDrag),
  useEventScroll: () => (Hook_UseEventScroll),
  useLoadAudio: () => (Hook_useLoadAudio),
  useLoadImage: () => (Hook_useLoadImage),
...
;// CONCATENATED MODULE: ./package/Canvas2dExtensions/Module.Graph.js
...
;// CONCATENATED MODULE: ./package/Canvas2dExtensions/Module.Location.js
...
;// CONCATENATED MODULE: ./package/Canvas2dExtensions/Util.CaculateRect.js
...
/* harmony default export */ const Util_CaculateRect = (caculateRect);
;// CONCATENATED MODULE: ./package/Canvas2dExtensions/Util.CreateEventLinstener.js
const createEventLinstener = () => {
  var event = [];
  var eventWithCanvas = [];
  const execute = (e, type, option) => {
    const exe = event.filter(i => i.type === type).sort((a, b) => {
  ...
  return {
    ...
    clearEventListenerWithCanvas
  };
};
/* harmony default export */ const Util_CreateEventLinstener = (createEventLinstener);
;// CONCATENATED MODULE: ./package/Canvas2dExtensions/Util.CreateOffscreenCanvas.js
...
/* harmony default export */ const Util_CreateOffscreenCanvas = (createOffscreenCanvas);
;// CONCATENATED MODULE: ./package/Canvas2dExtensions/index.js
...
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Core.Canvas.js
const App = {
...
/* harmony default export */ const Tag_Core_Canvas = (App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Core.EventListener.js
const Tag_Core_EventListener_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Core_EventListener = (Tag_Core_EventListener_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Arc.js
const Tag_Component_Arc_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Component_Arc = (Tag_Component_Arc_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Bezier.js
const Tag_Component_Bezier_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Component_Bezier = (Tag_Component_Bezier_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Circle.js
const Tag_Component_Circle_App = {
  onConstructMounted: dom => {
    dom.props.radius = dom.element.props.radius;
    dom.props.sAngle = dom.element.props.sAngle;
    dom.props.eAngle = dom.element.props.eAngle;
...
/* harmony default export */ const Tag_Component_Circle = (Tag_Component_Circle_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Image.js
const Tag_Component_Image_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Component_Image = (Tag_Component_Image_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Layout.js
...
const Tag_Component_Layout_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Component_Layout = (Tag_Component_Layout_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Line.js
const Tag_Component_Line_App = {
  onConstructMounted: dom => {
    dom.props.path = dom.element.props.path && JSON.parse(JSON.stringify(dom.element.props.path));
  },
  onRenderMount: dom => {
...
/* harmony default export */ const Tag_Component_Line = (Tag_Component_Line_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Quadratic.js
const Tag_Component_Quadratic_App = {
  onConstructMounted: dom => {
    dom.props.path = dom.element.props.path && JSON.parse(JSON.stringify(dom.element.props.path));
  },
  onRenderMount: dom => {
...
/* harmony default export */ const Tag_Component_Quadratic = (Tag_Component_Quadratic_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Rect.js
const Tag_Component_Rect_App = {
  onRenderMount: dom => {
    dom.path = context => {
...
/* harmony default export */ const Tag_Component_Rect = (Tag_Component_Rect_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.RectRadiusArc.js
const Tag_Component_RectRadiusArc_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Component_RectRadiusArc = (Tag_Component_RectRadiusArc_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.RectRadiusRect.js
const Tag_Component_RectRadiusRect_App = {
  onConstructMounted: dom => {
    dom.props.radius = dom.element.props.radius && JSON.parse(JSON.stringify(dom.element.props.radius));
  },
  onRenderMount: dom => {
...
/* harmony default export */ const Tag_Component_RectRadiusRect = (Tag_Component_RectRadiusRect_App);
;// CONCATENATED MODULE: ./package/Canvas2d/Tag.Component.Text.js
const Tag_Component_Text_App = {
  onConstructMounted: dom => {
...
/* harmony default export */ const Tag_Component_Text = (Tag_Component_Text_App);
...
const pick = tag => {
  ...
  if (tagLocaleLowerCase === 'canvas') return Tag_Core_Canvas;
  if (tagLocaleLowerCase === 'eventlistener') return Tag_Core_EventListener;
  if (tagLocaleLowerCase === 'arc') return Tag_Component_Arc;
  if (tagLocaleLowerCase === 'bezier') return Tag_Component_Bezier;
  if (tagLocaleLowerCase === 'circle') return Tag_Component_Circle;
  if (tagLocaleLowerCase === 'image') return Tag_Component_Image;
  if (tagLocaleLowerCase === 'layout') return Tag_Component_Layout;
  if (tagLocaleLowerCase === 'line') return Tag_Component_Line;
  if (tagLocaleLowerCase === 'quadratic') return Tag_Component_Quadratic;
  if (tagLocaleLowerCase === 'rect') return Tag_Component_Rect;
  if (tagLocaleLowerCase === 'rectradiusarc') return Tag_Component_RectRadiusArc;
  if (tagLocaleLowerCase === 'rectradiusrect') return Tag_Component_RectRadiusRect;
  if (tagLocaleLowerCase === 'text') return Tag_Component_Text;
};
...
function Component_Accordion_App(props) {
  ...
  return /*#__PURE__*/React.createElement("layout", {
  ...
  }, /*#__PURE__*/React.createElement("rectradiusarc", props.onAccordion), /*#__PURE__*/React.createElement("layout", {
    h: titleH,
    item: true
  }, /*#__PURE__*/React.createElement("rectradiusarc", props.onTitle), /*#__PURE__*/React.createElement("rectradiusarc", {
    beginPath: true,
    clip: true,
    ...
    item: true
  }, /*#__PURE__*/React.createElement("rectradiusarc", props.onContent), /*#__PURE__*/React.createElement("rectradiusarc", {
    beginPath: true,
    clip: true
...
const Component_Text_App = props => {
  ...
  React.useEffectImmediate(() => {
    offscreenCanvas.current = Util_CreateOffscreenCanvas(0, 0);
...
function Component_Button_App(props) {
  ...
  return /*#__PURE__*/React.createElement("layout", {
    ...
    w: w,
    h: h
  }, /*#__PURE__*/React.createElement("rectradiusarc", _extends({
    beginPath: true,
    radius: radius
  }, props.onButton)), /*#__PURE__*/React.createElement("rectradiusarc", {
    beginPath: true,
    fill: mode === 'fill',
    stroke: mode === 'stroke',
    clip: true,
...
;// CONCATENATED MODULE: ./package/ReactCanvas2dExtensions/Component.CanvasContainer.js

function Component_CanvasContainer_App(props) {
...
/* harmony default export */ const Component_CanvasContainer = (Component_CanvasContainer_App);
...
function Component_CanvasOffscreen_App(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, update.current ? /*#__PURE__*/React.createElement("canvas", {
    canvas: offscreenCanvas.current,
    context: offscreenContext.current,
    onConstructMounted: onConstructMountedLayout
  }, props.children) : null, /*#__PURE__*/React.createElement("image", {
    gx: 0,
    gy: 0,
    onConstructMounted: onConstructMountedImage
  }));
}
...
const Component_CoordinateHelper_App = props => {
  ...
  return /*#__PURE__*/React.createElement("layout", {
  ...
  }, repeatX !== undefined && repeatY !== undefined ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rectradiusarc", {
    beginPath: true,
    fill: true,
    w: "0.1vmax",
    cx: "50%",
  ...
  }), /*#__PURE__*/React.createElement("rectradiusarc", {
    beginPath: true,
    fill: true,
    h: "0.1vmax",
    cy: "50%",
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rectradiusarc", {
      beginPath: true,
      fill: true,
      w: "0.1vmax",
...
;// CONCATENATED MODULE: ./package/ReactCanvas2dExtensions/Component.EventListenerContainer.js
function Component_EventListenerContainer_extends() { return Component_EventListenerContainer_extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, Component_EventListenerContainer_extends.apply(null, arguments); }


function Component_EventListenerContainer_App(props) {
  const eventListener = React.useRef();
  const offscreenCanvas = React.useRef();
  const offscreenContext = React.useRef();
  React.useEffectImmediate(() => {
    eventListener.current = Util_CreateEventLinstener();
    offscreenCanvas.current = Util_CreateOffscreenCanvas(0, 0);
    offscreenContext.current = offscreenCanvas.current.getContext('2d');
  }, []);
  return /*#__PURE__*/React.createElement("eventlistener", Component_EventListenerContainer_extends({
    offscreenCanvas: offscreenCanvas.current,
    offscreenContext: offscreenContext.current
  }, eventListener.current), props.children);
}
/* harmony default export */ const Component_EventListenerContainer = (Component_EventListenerContainer_App);
...
/* harmony default export */ const Hook_useLoadAudio = (useLoadAudio);
...
/* harmony default export */ const Hook_useEventDrag = (useEventDrag);
...
/* harmony default export */ const Hook_UseEventScroll = (useEventScroll);
...
/* harmony default export */ const Hook_useLoadImage = (useLoadImage);
...
;// CONCATENATED MODULE: ./package/ReactCanvas2d/Util.FindDom.js
const findDom = node => {
  var dom;
  var nodes = [node];
...
/* harmony default export */ const Util_FindDom = (findDom);
;// CONCATENATED MODULE: ./package/ReactCanvas2d/Util.CreateDom.js
...
/* harmony default export */ const Util_CreateDom = (createDom);
...
const Core_mount = (element, canvas, option) => {
  ...
  var Component = /*#__PURE__*/React.createElement(Component_CanvasContainer, {
    canvas: canvas,
    dpr: dpr
  }, /*#__PURE__*/React.createElement(Component_EventListenerContainer, null, Boolean(powered) === true ? /*#__PURE__*/React.createElement(Component_PoweredBy, null, element) : null, Boolean(powered) !== true ? element : null));
  React.mount(Component, renderFrameTimeDiffMax, node => Canvas2d.render(Util_CreateDom(Util_FindDom(node))));
  return {
    render: React.render
  };
};
...
var __webpack_exports__Canvas2dExtensions = __webpack_exports__.jt;
var __webpack_exports__React = __webpack_exports__.q_;
var __webpack_exports__ReactCanvas2d = __webpack_exports__.EA;
var __webpack_exports__ReactCanvas2dExtensions = __webpack_exports__.Yd;
var __webpack_exports__ReactExtensions = __webpack_exports__.wQ;
export { __webpack_exports__Canvas2d as Canvas2d, __webpack_exports__Canvas2dExtensions as Canvas2dExtensions, __webpack_exports__React as React, __webpack_exports__ReactCanvas2d as ReactCanvas2d, __webpack_exports__ReactCanvas2dExtensions as ReactCanvas2dExtensions, __webpack_exports__ReactExtensions as ReactExtensions };
