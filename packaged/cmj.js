...
__webpack_require__.d(__webpack_exports__, {
  Location: () => (/* reexport */ CanvasXML_Location),
  React: () => (/* reexport */ CanvasXML_React),
  ReactCanvas2d: () => (/* reexport */ CanvasXML_ReactCanvas2d),
  ReactCanvas2dComponent: () => (/* reexport */ CanvasXML_ReactCanvas2d_Component),
  ReactCanvas2dEvent: () => (/* reexport */ CanvasXML_ReactCanvas2d_Event),
  ReactCanvas2dPlugin: () => (/* reexport */ CanvasXML_ReactCanvas2d_Plugin),
  ReactCanvas2dTag: () => (/* reexport */ CanvasXML_ReactCanvas2d_Tag),
  ReactCanvas2dUtils: () => (/* reexport */ CanvasXML_ReactCanvas2d_Utils),
...
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Event.js


var CanvasXML_ReactCanvas2d_Event_event = [];
var eventWithCanvas = [];
const addEventListener = (type, callback) => {
  if (callback) CanvasXML_ReactCanvas2d_Event_event = [...CanvasXML_ReactCanvas2d_Event_event, {
    type,
    callback
  }];
};
const removeEventListener = (type, callback) => {
  if (callback) CanvasXML_ReactCanvas2d_Event_event = CanvasXML_ReactCanvas2d_Event_event.filter(i => i.type !== type || i.callback !== callback);
};
...
const clearEventListener = () => {
  CanvasXML_ReactCanvas2d_Event_event = [];
};
const execute = (e, type) => {
  const exe = CanvasXML_ReactCanvas2d_Event_event.filter(i => i.type === type).sort((a, b) => {
  ...
  exe.forEach(i => {
    ...
    var y;
    var device;
    if (window.ontouchstart === undefined) x = e.pageX * CanvasXML_ReactCanvas2d.dpr();
    if (window.ontouchstart === undefined) y = e.pageY * CanvasXML_ReactCanvas2d.dpr();
    if (window.ontouchstart !== undefined) x = e.pageX ? [e.pageX * CanvasXML_ReactCanvas2d.dpr()] : [...e.changedTouches].map(i => i * CanvasXML_ReactCanvas2d.dpr());
    if (window.ontouchstart !== undefined) y = e.pageY ? [e.pageY * CanvasXML_ReactCanvas2d.dpr()] : [...e.changedTouches].map(i => i * CanvasXML_ReactCanvas2d.dpr());
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Event = (ReactCanvas2dEvent);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Arc.js



const App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationUnmount(dom);
  },
  renderMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderMount_0(dom);
    CanvasXML_ReactCanvas2d.context().arc(dom.props.x, dom.props.y, dom.props.radius, dom.props.sAngle, dom.props.eAngle, dom.props.counterclockwise);
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderUnmount(dom);
  }
};
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Arc = (App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Clip.js



const CanvasXML_ReactCanvas2d_Tag_Component_Clip_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
  ...
  renderMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderMount_0(dom);
    CanvasXML_ReactCanvas2d.context().clip();
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderUnmount(dom);
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Clip = (CanvasXML_ReactCanvas2d_Tag_Component_Clip_App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Fill.js



const CanvasXML_ReactCanvas2d_Tag_Component_Fill_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
  ...
  renderMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderMount_0(dom);
    CanvasXML_ReactCanvas2d.context().fill();
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderUnmount(dom);
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Fill = (CanvasXML_ReactCanvas2d_Tag_Component_Fill_App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Image.js
...
const CanvasXML_ReactCanvas2d_Tag_Component_Image_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
  ...
  renderMount: dom => {
    ...
    if (params !== undefined) {
      CanvasXML_ReactCanvas2d.context().drawImage(dom.props.image, params.sx, params.sy, params.sw, params.sh, params.x, params.y, params.w, params.h);
    }
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Image = (CanvasXML_ReactCanvas2d_Tag_Component_Image_App);
...
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Layout.js
...
const CanvasXML_ReactCanvas2d_Tag_Component_Layout_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
    if (Boolean(dom.props.container) === true && dom.children.length > 0) {
      ...
      childrenDom.forEach(i => CanvasXML_ReactCanvas2d.relocation({
        ...i,
        children: []
      }));
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Layout = (CanvasXML_ReactCanvas2d_Tag_Component_Layout_App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Rect.js



const CanvasXML_ReactCanvas2d_Tag_Component_Rect_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
  ...
  renderMount: dom => {
    ...
    CanvasXML_ReactCanvas2d.context().moveTo(dom.props.x, dom.props.y + radius[0]);
    CanvasXML_ReactCanvas2d.context().arcTo(dom.props.x, dom.props.y, dom.props.x + radius[0], dom.props.y, radius[0]);
    CanvasXML_ReactCanvas2d.context().lineTo(dom.props.x + dom.props.w - radius[1], dom.props.y);
    CanvasXML_ReactCanvas2d.context().arcTo(dom.props.x + dom.props.w, dom.props.y, dom.props.x + dom.props.w, dom.props.y + radius[1], radius[1]);
    CanvasXML_ReactCanvas2d.context().lineTo(dom.props.x + dom.props.w, dom.props.y + dom.props.h - radius[2]);
    CanvasXML_ReactCanvas2d.context().arcTo(dom.props.x + dom.props.w, dom.props.y + dom.props.h, dom.props.x + dom.props.w - radius[2], dom.props.y + dom.props.h, radius[2]);
    CanvasXML_ReactCanvas2d.context().lineTo(dom.props.x + radius[3], dom.props.y + dom.props.h);
    CanvasXML_ReactCanvas2d.context().arcTo(dom.props.x, dom.props.y + dom.props.h, dom.props.x, dom.props.y + dom.props.h - radius[3], radius[3]);
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderUnmount(dom);
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Rect = (CanvasXML_ReactCanvas2d_Tag_Component_Rect_App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Stroke.js



const CanvasXML_ReactCanvas2d_Tag_Component_Stroke_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
  ...
  renderMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderMount_0(dom);
    CanvasXML_ReactCanvas2d.context().stroke();
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
    CanvasXML_ReactCanvas2d_Tag.renderUnmount(dom);
...
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Stroke = (CanvasXML_ReactCanvas2d_Tag_Component_Stroke_App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.Component.Text.js



const caculateLine = (text, font, w, split = '') => {
  CanvasXML_ReactCanvas2d.context().save();
  CanvasXML_ReactCanvas2d.context().font = font;
  const px = Number(CanvasXML_ReactCanvas2d.context().font.match(/\d+px/)[0].replace('px', ''));
  var caculateText = '';
  var caculateTextLine = [];
  text = text.split(split).map((i, index) => index ? [split, i] : [i]).flat();
  text.forEach((i, index) => {
    const tw = CanvasXML_ReactCanvas2d.context().measureText(caculateText + i).width;
  ...
  caculateTextLine = caculateTextLine.map(i => {
    return {
      text: i.trim(),
      w: CanvasXML_ReactCanvas2d.context().measureText(i.trim()).width,
      h: px,
      font: CanvasXML_ReactCanvas2d.context().font
    };
  });
  CanvasXML_ReactCanvas2d.context().restore();
...
const CanvasXML_ReactCanvas2d_Tag_Component_Text_App = {
  locationMount: dom => {
    CanvasXML_ReactCanvas2d_Tag.locationMount(dom);
  },
  locationUnmount: dom => {
  ...
  renderMount: dom => {
    ...
    if (Boolean(dom.props.wrap) === true) {
      ...
      line.forEach((i, index) => {
        ...
        if (Boolean(dom.props.fillText) === true) CanvasXML_ReactCanvas2d.context().fillText(i.text, x, y);
        if (Boolean(dom.props.strokeText) === true) CanvasXML_ReactCanvas2d.context().strokeText(i.text, x, y);
      });
    }
    if (Boolean(dom.props.wrap) !== true) {
      const px = Number(CanvasXML_ReactCanvas2d.context().font.match(/\d+px/)[0].replace('px', ''));
      var w = CanvasXML_ReactCanvas2d.context().measureText(dom.props.text).width;
      var h = px * lineHeight;
      var x = dom.props.x;
      var y = dom.props.y;
      y = y - px * 0.18 - (h - px) * 0.5;
      ...
      if (Boolean(dom.props.fillText) === true) CanvasXML_ReactCanvas2d.context().fillText(dom.props.text, x, y);
      if (Boolean(dom.props.strokeText) === true) CanvasXML_ReactCanvas2d.context().strokeText(dom.props.text, x, y);
    }
    CanvasXML_ReactCanvas2d_Tag.renderMount_1(dom);
  },
  renderUnmount: dom => {
...
CanvasXML_ReactCanvas2d_Tag_Component_Text_App.caculateLine = caculateLine;
CanvasXML_ReactCanvas2d_Tag_Component_Text_App.caculateLineLocation = caculateLineLocation;
CanvasXML_ReactCanvas2d_Tag_Component_Text_App.CaculateLine = CaculateLine;
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag_Component_Text = (CanvasXML_ReactCanvas2d_Tag_Component_Text_App);
;// CONCATENATED MODULE: ./package/CanvasXML.ReactCanvas2d.Tag.js
...
const renderMount_0 = dom => {
  CanvasXML_ReactCanvas2d.context().save();
  if (dom.props.globalAlpha !== undefined) CanvasXML_ReactCanvas2d.context().globalAlpha = dom.props.globalAlpha;
  if (dom.props.font !== undefined) CanvasXML_ReactCanvas2d.context().font = dom.props.font;
  if (dom.props.fillStyle !== undefined) CanvasXML_ReactCanvas2d.context().fillStyle = dom.props.fillStyle;
  if (dom.props.strokeStyle !== undefined) CanvasXML_ReactCanvas2d.context().strokeStyle = dom.props.strokeStyle;
  if (Boolean(dom.props.beginPath) === true) CanvasXML_ReactCanvas2d.context().beginPath();
};
const renderMount_1 = dom => {
  if (Boolean(dom.props.clip) === true) CanvasXML_ReactCanvas2d.context().clip();
  if (Boolean(dom.props.fill) === true) CanvasXML_ReactCanvas2d.context().fill();
  if (Boolean(dom.props.stroke) === true) CanvasXML_ReactCanvas2d.context().stroke();
  if (Boolean(dom.props.isolated) === true) CanvasXML_ReactCanvas2d.context().restore();
};
const renderUnmount = dom => {
  if (Boolean(dom.props.isolated) !== true) CanvasXML_ReactCanvas2d.context().restore();
  if (dom.props.onClick) CanvasXML_ReactCanvas2d_Event.addEventListener('click', e => dom.props.onClick({
    ...e,
    dom
  }));
  if (dom.props.onTouchStart) CanvasXML_ReactCanvas2d_Event.addEventListener('touchstart', e => dom.props.onTouchStart({
    ...e,
    dom
  }));
  if (dom.props.onTouchMove) CanvasXML_ReactCanvas2d_Event.addEventListener('touchmove', e => dom.props.onTouchMove({
    ...e,
    dom
  }));
  if (dom.props.onTouchEnd) CanvasXML_ReactCanvas2d_Event.addEventListener('touchend', e => dom.props.onTouchEnd({
    ...e,
    dom
  }));
  if (dom.props.onMouseDown) CanvasXML_ReactCanvas2d_Event.addEventListener('mousedown', e => dom.props.onMouseDown({
    ...e,
    dom
  }));
  if (dom.props.onMouseMove) CanvasXML_ReactCanvas2d_Event.addEventListener('mousemove', e => dom.props.onMouseMove({
    ...e,
    dom
  }));
  if (dom.props.onMouseUp) CanvasXML_ReactCanvas2d_Event.addEventListener('mouseup', e => dom.props.onMouseUp({
    ...e,
    dom
  }));
};
const pick = tag => {
  if (tag === 'arc') return CanvasXML_ReactCanvas2d_Tag_Component_Arc;
  if (tag === 'clip') return CanvasXML_ReactCanvas2d_Tag_Component_Clip;
  if (tag === 'fill') return CanvasXML_ReactCanvas2d_Tag_Component_Fill;
  if (tag === 'image') return CanvasXML_ReactCanvas2d_Tag_Component_Image;
  if (tag === 'layout') return CanvasXML_ReactCanvas2d_Tag_Component_Layout;
  if (tag === 'rect') return CanvasXML_ReactCanvas2d_Tag_Component_Rect;
  if (tag === 'stroke') return CanvasXML_ReactCanvas2d_Tag_Component_Stroke;
  if (tag === 'text') return CanvasXML_ReactCanvas2d_Tag_Component_Text;
};
const ReactCanvas2dComponentTag = {
  pick,
  locationMount,
  locationUnmount,
  renderMount_0,
  renderMount_1,
  renderUnmount,
  Arc: CanvasXML_ReactCanvas2d_Tag_Component_Arc,
  Clip: CanvasXML_ReactCanvas2d_Tag_Component_Clip,
  Fill: CanvasXML_ReactCanvas2d_Tag_Component_Fill,
  Image: CanvasXML_ReactCanvas2d_Tag_Component_Image,
  Layout: CanvasXML_ReactCanvas2d_Tag_Component_Layout,
  Rect: CanvasXML_ReactCanvas2d_Tag_Component_Rect,
  Stroke: CanvasXML_ReactCanvas2d_Tag_Component_Stroke,
  Text: CanvasXML_ReactCanvas2d_Tag_Component_Text
};
/* harmony default export */ const CanvasXML_ReactCanvas2d_Tag = (ReactCanvas2dComponentTag);
...
const CanvasXML_ReactCanvas2d_renderListener = node => {
  context.clearRect(0, 0, canvas.width, canvas.height);
  CanvasXML_ReactCanvas2d_Event.clearEventListener();
...
const relocation = dom => {
  if (CanvasXML_ReactCanvas2d_Tag.pick(dom.element.tag) !== undefined) {
    CanvasXML_ReactCanvas2d_Tag.pick(dom.element.tag).locationMount(dom);
  ...
  if (CanvasXML_ReactCanvas2d_Tag.pick(dom.element.tag) !== undefined) {
    CanvasXML_ReactCanvas2d_Tag.pick(dom.element.tag).locationUnmount(dom);
    if (typeof dom.props.onLocationUnmount === 'function') dom.props.onLocationUnmount(dom);
  }
};
const rerender = dom => {
  if (CanvasXML_ReactCanvas2d_Tag.pick(dom.element.tag) !== undefined) {
    CanvasXML_ReactCanvas2d_Tag.pick(dom.element.tag).renderMount(dom);
...
const CanvasXML_ReactCanvas2d_Component_Button_App = props => {
  ...
  return /*#__PURE__*/CanvasXML_React.createElement("layout", _extends({}, coordinate, {
    ...
    verticalCenter: true,
    horizontalCenter: true
  }), CanvasXML_ReactCanvas2d_Tag.Text.caculateTextLine(layoutprops.w, props.text).map(i => {
...
const useLocationBox = props => {
  ...
  CanvasXML_React.useEffect(() => {
    if (ref.current) {
      const key = Object.keys(location);
      const box = CanvasXML_Location.box(CanvasXML_ReactCanvas2d_Utils.flatDom(ref.current).filter(i => i !== ref.current).map(i => i.props));
...
/* harmony default export */ const package_0 = ({
  ...
  ReactCanvas2dComponent: CanvasXML_ReactCanvas2d_Component,
  ReactCanvas2dEvent: CanvasXML_ReactCanvas2d_Event,
  ReactCanvas2dPlugin: CanvasXML_ReactCanvas2d_Plugin,
  ReactCanvas2dTag: CanvasXML_ReactCanvas2d_Tag,
  ReactCanvas2dUtils: CanvasXML_ReactCanvas2d_Utils
});
